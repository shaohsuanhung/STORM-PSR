...
path_name_stage2=try_run_industreal_stage2_0926_skip
EPOCH_stage2=50
...
python train.py --run_name  $path_name_stage2 --config configs/IndustReal/temporal-F65-dim128.yaml --dtype embedding --data_dir $embedding_CSV_data_dir --psr_label_path $psr_label_path --log_path $log_path --epoch $EPOCH_stage2 --skip_factor 3 --sampling_strategy bimodal --lr 5e-3 --job_file_mode
python train.py --run_name  $path_name_stage2 --config configs/IndustReal/temporal-F256-dim128.yaml --dtype embedding --data_dir $embedding_CSV_data_dir --psr_label_path $psr_label_path --log_path $log_path --epoch $EPOCH_stage2 --skip_factor 0 --sampling_strategy bimodal --lr 5e-3 --n_iter 10000 --job_file_mode
