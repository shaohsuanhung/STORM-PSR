...
path_name_stage1=try_run_industreal_ep100_iter500
EPOCH_stage1=100
log_path_stage1=/shared/nl011006/res_ds_ml_restricted/shaohung/train_log/handover/stage1
video_data_path=/shared/nl011006/res_ds_ml_restricted/TimSchoonbeek/IndustReal/recordings
syn_path=/shared/nl011006/res_ds_ml_restricted/TimSchoonbeek/industreal_cont
...
path_name_stage2=try_run_industreal_stage2_tmp_enc
EPOCH_stage2=50
skip_factor=3
psr_label_path=/shared/nl011006/res_ds_ml_restricted/shaohung/IndustReal_corrected_PSR 
...
#-- 3.5 Test the model with only forwarding the embedding to the temproal encoder
...
rgb_video_path=/shared/nl011006/res_ds_ml_restricted/shaohung/IndustReal/all_rgb_videos
...
cd /hpc/home/shaohung/code/KeyStep/temporal_stream/train_spatial_temporal
path_name_ft=try_run_industreal_stage2_ft
EPOCH_ft=50
psr_label_path=/shared/nl011006/res_ds_ml_restricted/shaohung/IndustReal_corrected_PSR 
...
#-- 4.5 Test and evaluate the model by forwarding the video to the whole temporal stream model.
