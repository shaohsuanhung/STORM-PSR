...
path_name_stage2=try_run_meccano_stage2_ft
EPOCH_stage2=50
...
video_path=/shared/nl011006/res_ds_ml_restricted/TimSchoonbeek/meccano/frames
pretrained_file=/shared/nl011006/res_ds_ml_restricted/shaohung/train_log/handover/stage2/try_run_meccano_stage2/checkpoints/weights_50.pth
spatial_pretrained=/shared/nl011006/res_ds_ml_restricted/shaohung/train_log/handover/stage1/try_run_meccano_100/checkpoints/best.pth

python fine_tuning.py --run_name  $path_name_stage2 --config configs/MECCANO/SimStepNet_F65-dim128.yaml --pretrained_weight $pretrained_file --spatial_pretrained_weight $spatial_pretrained --dtype video --data_dir $video_path --psr_label_path $psr_label_path --log_path $log_path --epoch $EPOCH_stage2 --skip_factor 3 --sampling_strategy bimodal --lr 5e-3 --job_file_mode --sanity_check
